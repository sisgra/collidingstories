  ...
  return (
    <div className="portfolio-item-wrapper">
      <div className="portfolio-content">
        ...
        <h2 className="title">BALAZUCADES FESTIVAL</h2>

        <p className="section-des">
        At the occasion of les Balazucades festival, in a fantastic setting on a pétanque pitch at the foot of the church, in Balazuc, one of the most beautiful french villages.
        </p>
